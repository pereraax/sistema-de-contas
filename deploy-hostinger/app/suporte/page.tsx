...
export default function SuportePage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      resposta: 'Oferecemos três planos: Teste (gratuito com funcionalidades limitadas), Básico (R$ 9,90/mês) e Premium (R$ 49,90/mês) com acesso completo a todas as funcionalidades.'
    },
    {
