-- ============================================
-- CORRIGIR USER_ID NA TABELA LEMBRETES (VERSÃO FINAL)
-- ============================================
...
-- 2. Tornar user_id nullable PRIMEIRO (antes de fazer UPDATE)
ALTER TABLE lembretes 
...
-- 6. Verificar se a coluna é nullable (deve retornar 'YES')
SELECT 
  column_name,
  is_nullable,
  data_type
