...
/** Conta todos os registros (entrada + saida + divida) da conta (via users da conta). */
async function countRegistrosPlen(supabase: SupabaseClient, accountOwnerId: string): Promise<number> {
